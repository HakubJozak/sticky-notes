...
`;
  ...
  const SEPARATOR = " · ";
  const NONE = "";
  function createPicker({ doc, storage, onOpen }) {
  ...
  function createLayer({ root, key, storage, onPick, onChange, onRemove, onClear, onDropOrphans, onExport, onSend, onShot, onAutoShot, onConnect, onSessionsOpen }) {
    ...
    function onBarClick(event) {
      ...
      if (!command) return;
      if (command !== AUTO_SHOT_COMMAND) moreEl.open = false;
